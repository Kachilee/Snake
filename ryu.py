...
#                                                    #
# Github: https://www.github.com/kachilee              #
#                                                    #
# Created By Kachi                #
#                                                    #
# Tipe Python3                                       #
...
class about:
	...
	def tentang(self):
		...
		if "mbasic_logout_button" not in anjir:
			...
			print(" [05] Crack ID From Friend Request")
			print(" [06] Crack ID From Facebook Group")
			print(" [07] Crack With Phone Number")
			print(" [99] Check Crack Result")
